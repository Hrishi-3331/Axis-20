...
public class ExhibitionDetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String id = intent.getStringExtra("exhibition_id");

        mRef = FirebaseDatabase.getInstance().getReference().child("exhibitions").child(id);

        dialog = new ProgressDialog(ExhibitionDetails.this);
        dialog.setTitle("Loading Details");
        dialog.setMessage("Please wait...");
        dialog.setCanceledOnTouchOutside(false);


        LinearLayoutManager manager = new LinearLayoutManager(ExhibitionDetails.this, LinearLayoutManager.VERTICAL, false);
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<Coordinator, ContactViewHolder> adapter = new FirebaseRecyclerAdapter<Coordinator, ContactViewHolder>(Coordinator.class, R.layout.coordinators_box, ContactViewHolder.class, mRef.child("contact")) {
            ...
            protected void populateViewHolder(ContactViewHolder viewHolder, Coordinator model, int position) {
                viewHolder.setmView(ExhibitionDetails.this, model.getName(), model.getNumber(), model.getEmail());
                dialog.dismiss();
            }
        };
            ...
            this.mail.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent emailIntent = new Intent(Intent.ACTION_SENDTO, Uri.fromParts(
                            "mailto", mail, null));
                    emailIntent.putExtra(Intent.EXTRA_SUBJECT, "AXIS 20 Exhibition Details Enquiry");
